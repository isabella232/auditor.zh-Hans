...
此参考可提供有关 Adobe Experience Platform Auditor 执行的标记存在测试的更多信息。
...
<table id="table_98A2E3F7B3154EEFA76D0CAE2FE97CAB"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>通过 Adobe Experience Platform Launch 的 Advertising Cloud Extension 实施 Advertising Cloud 标记。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在 DOM 中未找到全局 _satellite 对象。未安装或无法执行 Platform Launch。 </p> </td> 
